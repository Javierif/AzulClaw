...
class AzulAgent:
    """
    Adapter that preserves the previous invoke_prompt contract while using
    Microsoft Agent Framework under the hood.
    """
...
async def create_agent(mcp_client):
    """Create an Agent Framework agent configured with Azure OpenAI and MCP tools."""
